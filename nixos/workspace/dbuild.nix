...
in {
    ...
    nix = {
      ...
      buildMachines = [ # Make sure to add the host auth key to the known hosts file of root on the client machine. For example by logging in from local root to the sshUser.
      {
